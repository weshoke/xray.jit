...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 349.0, 117.0, 16.0, 17.0 ],
					"style" : "",
					"text" : "V",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 480.0, 138.0, 26.0, 27.0 ],
					"style" : "",
					"text" : "∑^-1",
					"textcolor" : [ 0.8, 0.611765, 0.380392, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 604.0, 117.0, 22.0, 27.0 ],
					"style" : "",
					"text" : "U^T",
					"textcolor" : [ 0.8, 0.611765, 0.380392, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 358.0, 58.0, 16.0, 17.0 ],
					"style" : "",
					"text" : "U",
					"textcolor" : [ 0.8, 0.611765, 0.380392, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 19.0, 66.0, 226.0, 29.0 ],
					"style" : "",
					"text" : "takes the 3 matrices comprising the Singular Value Decomposition of a matrix as inputs",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 19.0, 121.0, 297.0, 40.0 ],
					"style" : "",
					"text" : "The pseudo inverse of a matrix can be calculated from the Singular Value Decomposition of a matrix where svd(A) = U∑V^T. The pseudo inverse of A is then pinv(A)=V∑^-1U^T.",
					"textcolor" : [ 0.698039, 0.705882, 0.654902, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 19.0, 94.0, 236.0, 18.0 ],
					"style" : "",
					"text" : "real or complex 1- or 2-D float matrices only",
					"textcolor" : [ 0.521569, 0.513726, 0.45098, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 19.0, 51.0, 144.0, 18.0 ],
					"style" : "",
					"text" : "pseudo-inverse of a matrix",
					"textcolor" : [ 0.698039, 0.705882, 0.654902, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 16.0, 27.0, 120.0, 29.0 ],
					"style" : "",
					"text" : "xray.jit.pinv",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 339.0, 77.0, 68.0, 19.0 ],
					"style" : "",
					"text" : "jit.transpose"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 339.0, 58.0, 15.0, 15.0 ],
					"style" : ""
				}
