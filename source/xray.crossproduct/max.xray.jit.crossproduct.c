...
void C74_EXPORT main(void)
{
	...
	setup((t_messlist **)&max_xray_jit_crossproduct_class, max_xray_jit_crossproduct_new, (method)max_xray_jit_crossproduct_free, (short)sizeof(t_max_xray_jit_crossproduct),
		0L, A_GIMME, 0);
