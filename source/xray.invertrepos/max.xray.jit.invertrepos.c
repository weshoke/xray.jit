...
void C74_EXPORT main(void)
{
	...
	setup((t_messlist **)&max_xray_jit_invertrepos_class, max_xray_jit_invertrepos_new, (method)max_xray_jit_invertrepos_free, (short)sizeof(t_max_xray_jit_invertrepos),
		0L, A_GIMME, 0);
