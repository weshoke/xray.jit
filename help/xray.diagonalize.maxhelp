...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 0,
					"offset" : [ -26.0, -36.0 ],
					"patching_rect" : [ 309.0, 201.0, 165.0, 64.0 ],
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 4,
					"numoutlets" : 0,
					"patching_rect" : [ 348.0, 284.0, 101.0, 21.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 126.0, 33.0, 33.0, 21.0 ],
					"style" : "",
					"text" : "read"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 199.0, 33.0, 31.0, 21.0 ],
					"style" : "",
					"text" : "stop"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 165.0, 33.0, 36.0, 21.0 ],
					"style" : "",
					"text" : "start"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 17.0, 119.0, 240.0, 180.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 67.0, 8.0, 41.0, 22.0 ],
					"style" : "default",
					"triscale" : 0.9
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 18.0, 8.0, 27.0, 27.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 18.0, 40.0, 68.0, 21.0 ],
					"style" : "",
					"text" : "qmetro 66"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 18.0, 68.0, 112.0, 21.0 ],
					"style" : "",
					"text" : "jit.qt.movie 320 2"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 18.0, 96.0, 130.0, 21.0 ],
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 135.5, 64.0, 27.5, 64.0 ],
					"source" : [ "obj-4", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 208.5, 64.0, 27.5, 64.0 ],
					"source" : [ "obj-5", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 174.5, 64.0, 27.5, 64.0 ],
					"source" : [ "obj-6", 0 ]
				}
